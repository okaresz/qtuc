...
class QcPlot : public QtuC::ErrorHandlerBase
{
	Q_OBJECT
public:
	explicit QcPlot(QObject *parent = 0);
	...
	bool addNewPlot( PlotConfig *plotCfg )
		{ return mPlotManager->addNewPlot(plotCfg); }

	inline PlotManager *plotManager() const
		{ return mPlotManager; }
...
signals:
	...
	void deviceVariableCreated( const QtuC::DeviceStateVariableBase *newVar, const QString &guiHint );
